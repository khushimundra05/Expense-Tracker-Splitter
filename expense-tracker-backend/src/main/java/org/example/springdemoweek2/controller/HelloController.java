...
import org.example.springdemoweek2.service.UserSummaryService;
...
//    }
    ...
    public UserSummaryResponseDto getUserSummary(@PathVariable Long id) {
        return userSummaryService.getUserSummary(id);
    }
}